...
typography:
  cjk:     { fontFamily: "Noto Sans SC", source: "assets/fonts/NotoSansSC-Variable.ttf", weight: "400 900", lineHeight: 1.15, description: "Embedded Chinese coverage; preserve Broadside weight and scale hierarchy" }
  # — reading ramp —
